...
from tmf.handlers.static_handlers import system_blueprint, component_blueprint, boundary_blueprint, data_flow_blueprint, threat_blueprint
...
if __name__ == "__main__":
    ...
    app.register_blueprint(threat_blueprint)
